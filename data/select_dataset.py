...
def define_Dataset(dataset_opt):
    ...
    elif dataset_type in ['ffdnet-ext', 'denoising-noiselevel-ext']:
        from data.dataset_ffdnet_extension import DatasetFFDNet_Ext as D

    elif dataset_type in ['ffdnet-blind', 'denoising-blind']:
        from data.dataset_ffdnet_blind import DatasetFFDNet_Blind as D

    elif dataset_type in ['fdncnn', 'denoising-noiselevelmap']:
        from data.dataset_fdncnn import DatasetFDnCNN as D

    elif dataset_type in ['denoising-real-sidd']:
        from data.dataset_real import DatasetRealSIDD as D
