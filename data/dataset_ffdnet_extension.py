...
class DatasetFFDNet_Ext(data.Dataset):
    """
    # -----------------------------------------
    ...
    def __init__(self, opt):
        super(DatasetFFDNet_Ext, self).__init__()
        self.opt = opt
        ...
        self.image_divisor = opt['image_divisor'] if opt['image_divisor'] else 8
    ...
    def __getitem__(self, index):
        ...
        if self.opt['phase'] == 'train':
            ...
            H, W  = img_H.shape[:2]
            H     = (H-self.image_extension)//self.image_divisor*self.image_divisor+self.image_extension
            W     = (W-self.image_extension)//self.image_divisor*self.image_divisor+self.image_extension
            img_H = img_H[:H,:W,:]
